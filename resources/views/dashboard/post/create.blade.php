...
@section('content')
<div class="flex flex-col w-full h-screen m-auto bg-white p-11 my-11">
    <div class="flex flex-col w-3/4 h-full m-auto">
    ...
    <form action="/dashboard/posts" method="POST" enctype="multipart/form-data">
        ...
        <input
            ...
            type="file" id="image" name="image" onchange="previewImage()" value="{{ old('image') }}">
        {{-- membuat preview image menggunakan javascript --}}
        <img class="img-preview img-fluid mt-2 col-4">
        {{-- lanjut ke ** --}}
        @error('image')
        <div class="invalid-feedback">
            {{ $message }}
        ...
        <input id="body" type="hidden" name="body" class="mb-4 @error('body') is-invalid @enderror" required value="{{ old('body') }}">
